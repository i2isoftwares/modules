import 'package:customerfeedback/database/database_helper.dart';
import 'package:customerfeedback/models/auditdetails.dart';
import 'package:customerfeedback/models/categorydetails.dart';
import 'package:customerfeedback/models/companydetails.dart';
import 'package:customerfeedback/models/locationdetails.dart';
import 'package:customerfeedback/models/questiondetails.dart';
import 'package:customerfeedback/models/sbudetails.dart';
import 'package:customerfeedback/models/scoredetails.dart';
  ...
  void scoreApi(BuildContext context) async {
    ...
    if (response != null) {
      ...
      if (response.status!) {
        ...
        // Navigator.popAndPushNamed(context, 'package:customerfeedback/');
        Get.offAndToNamed(CFRoutes.home);
      }
    }
  }
